...
config.appName = 'YouSeeU Sync Meeting HTML5 Client';
...
config.defaultWelcomeMessage = 'Welcome to %%CONFNAME%%!\r\r.\r\rTo join the audio bridge click the gear icon (upper-right hand corner).  Use a headset to avoid causing background noise for others.\r\r\r';

config.defaultWelcomeMessageFooter = `This server is running a build of YouSeeU Sync Meeting ${config.bbbServerVersion}.`;
