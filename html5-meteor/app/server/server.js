  ...
  return this.handleRedisMessage = function(data, callback) {
    ...
    if(message != null && message.header != null && payload != null) {
      ...
      // for now not handling this serially #TODO
        ...
        return callback();
      } else if(eventName === "presentation_page_generated_message") {
        presentationConversionProgress(payload);
        return callback();
      } else if(eventName ==="presentation_conversion_done_message") {
        presentationConversionDone(payload);
        return callback();
      } else if(eventName === "presentation_conversion_error_message"){
        presentationConversionError(payload);
        return callback();
